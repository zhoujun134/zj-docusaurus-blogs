...
import { CommentSwitches, shouldShowComments } from '@site/src/features/comments/commentVisibility'
  ...
  return {
    ...
    description: (
      <>
        ...
        <p>
          <strong>原文链接: </strong>
          <a href={curDocsPath}>{curDocsPath}</a>
        </p>
        <p>
          <strong>作者: </strong>
        ...
        <p>
          <Link href={siteConfig.url}>{siteConfig.title}</Link>{' '}
          致力于分享有价值的信息和知识。我们尊重并保护知识产权。本文仅代表作者观点，不代表任何立场。
          如果本文有所侵权，请联系作者删除或修改！
        </p>
      </>
    ),
  ...
  return (
    <BlogPostProvider content={props.content} isBlogPostPage>
      <HtmlClassNameProvider
        className={cn(ThemeClassNames.wrapper.blogPages, ThemeClassNames.page.blogPostPage)}
      >
