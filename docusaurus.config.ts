...
const config: Config = {
  ...
  projectName: 'zj-docusaurus-blogs', // Usually your repo name.
  ...
  plugins: [
    ...
    ['docusaurus-plugin-baidu-tongji', { token: '3fe9ea74bd372ee22bcbf0caaf670701' }],
    [
    ...
    [
      './src/plugins/plugin-content-blog', // 为了实现全局 blog 数据，必须改写 plugin-content-blog 插件
      {
        ...
        feedOptions: {
          type: 'all',
          title: 'Z 不殊',
          copyright: `Copyright © ${new Date().getFullYear()} Z 不殊. Built with Docusaurus.<p><a href="https://beian.miit.gov.cn/" class="footer_lin">${beian}</a></p>`,
        },
      },
    ],
    // ...other plugins
    async function docusaurusTailwindcssPlugin() {
      return {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: '掘金',
              href: 'https://juejin.cn/user/1368247499489981',
            },
            {
              label: '邮箱',
              href: 'mailto:zbus.top@qq.com',
            },
          ],
        },
        {
      ...
      copyright: `
            <p style="margin-bottom: 0;"><a href="https://beian.miit.gov.cn/">${beian}</a></p>
        <p style="display: inline-flex; align-items: center;"><img style="height:20px;margin-right: 0.5rem;" src="/img/police.png" alt="police" height="20"/><a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=${
          beian1.match(/\d+/)?.[0]
        }" >${beian1}</a></p>
        <p>Copyright © 2024 - ${new Date().getFullYear()} Z 不殊. Built with Docusaurus.</p>
            `,
    },
    prism: {
